...
def main():
    ...
    parser.add_argument('--buffer_size', '-bs', type=int, default=200000)

    parser.add_argument('--polyak', '-pk', type=int, default=0.005)
    parser.add_argument('--gamma', '-g', type=int, default=0.99)



    #actor parameters
    parser.add_argument('--pi_lr', '-plr', type=int, default=3e-4)
    parser.add_argument('--pi_output_activation', '-p_oact', type=str, default='tanh')
    parser.add_argument('--pi_activation', '-p_act', type=str, default='relu')
    parser.add_argument('--pi_hidden_sizes', '-p_hs', nargs='+', default=[256, 512, 512, 256])

    #q parameters
    parser.add_argument('--q_lr', '-qlr', type=int, default=3e-4)
    parser.add_argument('--q_output_activation', '-q_oact', type=str, default='identity')
    parser.add_argument('--q_activation', '-q_act', type=str, default='relu')
    parser.add_argument('--q_hidden_sizes', '-q_hs', nargs='+', default=[256, 512, 512, 256])
    ...
    parser.add_argument('--num_test_episodes', '-num_test', type=int, default=1)
