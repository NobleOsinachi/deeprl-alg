...
class DDPGAgent(BaseAgent):
    def __init__(self, env, agent_params):
        ...
        self.actor_critic = MLPPolicyDDPG(self.ac_dim, self.ob_dim, pi_params, q_params)
    ...
    def compute_q_loss(self, paths):
        ...
        with torch.no_grad():
            q_pi_targ = self.actor_critic_targ.q(next_o, self.actor_critic_targ.pi(next_o))
    ...
    def load(self, path, epoch):
        self.actor_critic.load_model(path, epoch)
