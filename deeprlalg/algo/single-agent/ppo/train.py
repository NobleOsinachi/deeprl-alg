...
def main():
    ...
    parser.add_argument('--clip_ratio', '-cr', type=float, default=0.2)
    parser.add_argument('--gamma', '-g', type=float, default=0.99)
    parser.add_argument('--lam', '-lb', type=float, default=0.97)

    parser.add_argument('--target_kl', '-tkl', type=float, default=0.01)
    parser.add_argument('--num_train_pi_iters', '-npi', type=int, default=80)
    parser.add_argument('--num_train_v_iters', '-nvi', type=int, default=80)
