...
def main():
    ...
    parser.add_argument('--polyak', '-pk', type=float, default=0.995)
    parser.add_argument('--gamma', '-g', type=float, default=0.99)

    parser.add_argument('--noise_clip', '-nc', type=float, default=0.5)
    parser.add_argument('--target_noise', '-tn', type=float, default=0.2)
    parser.add_argument('--policy_delay', '-pd', type=float, default=2)
